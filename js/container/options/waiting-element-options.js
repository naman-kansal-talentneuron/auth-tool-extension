...
import WaitingElement from "../../element/waiting-element.js";
import ElementOptionsBase from "./element-options-base.js";
import MetaData from "../../config/meta-data.js";
import Utils from "../../utils.js";

export default class WaitingElementOptions extends ElementOptionsBase {
    #components = {
        txtDelay : null
    }
    ...
    constructor(nodeElement, parentElement) {
        ...
        this.nodeElement = new WaitingElement(nodeElement.elementId, 'WaitingElement', nodeElement.elementSelector,
