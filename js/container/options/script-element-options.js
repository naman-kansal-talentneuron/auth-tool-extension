...
import ScriptElement from "../../element/script-element.js";
...
export default class SelectElementOptions extends ElementOptionsBase {
    ...
    constructor(nodeElement, parentElement, onSaveCallback) {
        ...
        this.nodeElement = new ScriptElement(nodeElement.elementId, 'ScriptElement', nodeElement.elementSelector,
            nodeElement.elementSelectorType, nodeElement.elementParent, nodeElement.elementPersist, nodeElement.elementOptions,
            nodeElement.elementDocumentType, nodeElement.elementMultiple, nodeElement.elementMaxIteration, nodeElement.elementFetchType, 
            nodeElement.elementChildFirst, nodeElement.document,nodeElement.elementCRCFields, nodeElement.elementPersistWithData); 
