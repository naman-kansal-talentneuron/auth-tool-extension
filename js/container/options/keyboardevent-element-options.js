...
import KeyboardEvent from "../../element/keyboard-element.js";
import ElementOptionsBase from "./element-options-base.js";
import MetaData from "../../config/meta-data.js";
import Utils from "../../utils.js";

export default class KeyboardeventElementOptions extends ElementOptionsBase {
    #components = {        
        txtKeyCode: null
    }
    ...
    constructor(nodeElement, parentElement) {
        ...
        this.nodeElement = new KeyboardEvent(nodeElement.elementId, 'KeyboardElement', nodeElement.elementSelector,
    ...
    onSaveChanges(nodeElement) {
        let options = {          
            ...(this.#components.txtKey != "") && {key : this.#components.txtKey.val },
            ...(this.#components.txtKeyCode.val != "") && {keyCode : parseInt(this.#components.txtKeyCode.val) },
    ...
    createComponents() {
        ...
        this.createLabel('divLblKey', {style:lblStyle, id: 'lblKey' }, 'Options (Key)');
        this.#components.txtKey = new TextBox('divEleKey', 'uh_editor_txtKey','', this.nodeElement.elementOptions &&  this.nodeElement.elementOptions.key? this.nodeElement.elementOptions.key :'' ,'')

        this.createLabel('divLblKeyCode', {style:lblStyle, id: 'lblKeyCode' }, 'Options (KeyCode)');
        this.#components.txtKeyCode = new TextBox('divEleKeyCode', 'uh_editor_txtKeyCode','', this.nodeElement.elementOptions &&  this.nodeElement.elementOptions.keyCode? this.nodeElement.elementOptions.keyCode :'' ,'',null, null,null,null, 'number');
            ...
            rows: [
                {
                    attr: {style: classRow},
                    col : [                         
                         { attr: {style: colStyle} , divs: [{ attr: {style: classCol, id: "divLblKey"} }, {attr: { style: classColEle, id: "divEleKey"}}]} ,
                         { attr: {style: colStyle} , divs: [{ attr: {style: classCol, id: "divLblKeyCode"} }, {attr: { style: classColEle, id: "divEleKeyCode"}}]}                                                 
                    ]
                },
                {
                    attr: {style: classRow},
