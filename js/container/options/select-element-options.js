...
import SelectElement from "../../element/select-element.js";
import ElementOptionsBase from "./element-options-base.js";
import MetaData from "../../config/meta-data.js";
import Utils from "../../utils.js";

export default class SelectElementOptions extends ElementOptionsBase {
    #components = {
        txtSelect: null
    }
    ...
    constructor(nodeElement, parentElement) {
        ...
        this.nodeElement = new SelectElement(nodeElement.elementId, 'SelectElement', nodeElement.elementSelector,
            nodeElement.elementSelectorType, nodeElement.elementParent, nodeElement.elementPersist, nodeElement.elementOptions,
            undefined, nodeElement.elementSelect, nodeElement.document, nodeElement.elementCRCFields);
    ...
    onSaveChanges(nodeElement) {
        this.nodeElement.elementSelect = (this.#components.txtSelect.val != '') ? this.#components.txtSelect.val : undefined;       
        if (this.nodeElement.elementSelect != undefined && this.nodeElement.elementSelect != null) {
            let options = {
            ...
            document.getElementById('lblErrorMessage').setAttribute
    ...
    createComponents() {
        ...
        const lblStyleSelect = "width: 35px;  font-weight: 550";
        const lblReq = "width: 5px;  font-weight: 550 ; color:red";
        const lblErrorMessageReq = "color: red; display:none";
        this.createLabel('divLblSelect', { style: lblStyleSelect, id: 'lblSelect' }, 'Select');
        this.createLabel('divLblSelect', { style: lblReq, id: 'lblSelectRequired' }, '*');
        this.createLabel('divLblErrorMessageReq', { style: lblErrorMessageReq, id: 'lblErrorMessageReq' }, '');
        this.#components.txtSelect = new TextBox('divEleSelect', 'uh_editor_txtSelect', '', this.nodeElement.elementSelect ? this.nodeElement.elementSelect : '', '')
    ...
    createContainerDiv() {
        ...
        const  classColEleSelect = "display: inline-block;margin-left: 44px;";
            ...
            rows: [
                {
                    attr: { style: classRow },
                    col: [
                        { attr: { style: colStyle }, divs: [{ attr: { style: classCol, id: "divLblSelect" } }, { attr: { style: classColEleSelect, id: "divEleSelect" } }] },
