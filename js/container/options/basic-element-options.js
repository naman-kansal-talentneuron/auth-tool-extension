...
export default class BasicElementOptions extends ElementOptionsBase {
    ...
    constructor(nodeElement,parentElement, onSaveCallback) {
        ...
        this.nodeElement = new BasicElement(nodeElement.elementId, 'BasicElement', nodeElement.elementSelector, nodeElement.elementSelectorType, 
